...
const SectionTitle = ({ topText, middleText, bottomText }) => {
  return (
    <div className="w-[732px] max-w-full mx-auto flex flex-col gap-4 mt-[56px]">
      {topText && (
      ...
      {middleText && <h1 className="text-5xl font-semibold text-gradient text-center leading-[72px]">{middleText}</h1>}
