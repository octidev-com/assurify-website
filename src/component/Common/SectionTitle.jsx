...
const SectionTitle = ({ topText, middleText, bottomText }) => {
  return (
    <div className='mx-auto flex flex-col gap-2 mt-[32px] lg:mt-[56px]'>
      {topText && (
      ...
      {middleText && (
        <h1 className='text-[24px] lg:text-5xl font-semibold text-gradient text-center leading-[36px] lg:leading-[72px]'>
          {middleText}
        </h1>
      )}
      {bottomText && (
        <p className='text-[#A6A6A6] text-[12px] lg:text-lg font-light text-center leading-[18px] lg:leading-[27px]'>
          {bottomText}
        </p>
      )}
    </div>
