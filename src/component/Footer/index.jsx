          ...
          <div className="container relative pt-[100px] sm:pt-[150px] pb-[50px] sm:pb-[70px] mx-auto z-10 ">
            <div className="flex flex-col md:flex-row md:justify-between gap-8">
              ...
              <div className="max-w-[500px]">
                <img src={OrgIcon} alt="Assurify logo" className="w-[80px] sm:w-[100px] h-auto" />
              ...
              <div className="flex flex-col md:flex-row md:gap-[115px] gap-8">
                ...
                <div className="flex flex-col">
                  <p className="text-[#f7f7f7] text-lg font-semibold leading-normal">Company</p>
                  <div className="flex flex-col gap-4 mt-8">
                    <a href="#" className="text-[#fff] text-base font-light leading-6">
                      Home
                    </a>
                    <a href="#" className="text-[#fff] text-base font-light leading-6">
                      For Merchant
                    ...
                    <Link to="/privacy-policy" className="text-[#fff] text-base font-light leading-6">
                      Privacy Policy
                    </Link>
                  </div>
                </div>
                ...
                <div className="flex flex-col">
                  <label htmlFor="user-email" className="text-[#fff] text-lg sm:text-xl font-semibold leading-[30px]">
                    Newsletter
                  </label>
                  ...
                  <p className="mt-8 text-[#fff] text-lg sm:text-xl font-medium leading-[30px]">Follow us on</p>
