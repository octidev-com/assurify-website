...
const HowItWorks = () => {
  const howItWorksSteps = [
    {
      ...
      description: "Customers can opt-in for shipping protection at checkout, giving them confidence with every purchase.",
      image: stepImg1,
    },
    {
      id: 2,
      title: "Set Assurance Fees Easily",
      description: "Merchants control the shipping insurance fee—set it as a fixed amount or a percentage of the order value.",
      image: stepImg2,
    },
    {
      id: 3,
      title: "Efficient Management Panel",
      description: "Manage lost, damaged, returned, and refunded orders easily through the Assurify panel.",
      image: stepImg3,
    },
    {
      id: 4,
      title: "Automated Claims Processing",
      description: "Filing a claim takes just one click through our intuitive claims portal.",
      image: stepImg4,
    },
    {
      id: 5,
      title: "Boost Revenue & Trust",
      description: "Increase revenue and customer loyalty by offering guaranteed shipping protection.",
      image: stepImg5,
    },
    {
      id: 6,
      title: "Where Custom Meets Care",
      description: "Fully customize pricing and appearance to match your brand—backed by 24/7 expert support.",
      image: stepImg6,
    },
  ];
  ...
  return (
    <Container>
      <div ref={containerRef} className="mt-[50px] md:mt-[150px] min-h-screen overflow-x-hidden">
        {/* Preload Images */}
