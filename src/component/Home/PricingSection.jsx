  ...
  const pricingData = [
    {
      ...
      monthlyPrice: "$0.00",
      yearlyPrice: "$0.00",
      facilities: ["50 secure orders/month", "Claim Management", "Basic Analytics", "Chat Support"],
    },
    {
      id: 2,
      title: "Starter",
      monthlyPrice: "$9.00",
      yearlyPrice: "$97.20",
      facilities: ["600 secure orders/month", "Claim Management", "Return Management", "Basic Analytics", "Chat Support"],
    },
    {
      id: 3,
      title: "Starter Plus",
    ...
    },
    {
      ...
      monthlyPrice: "$49.00",
      yearlyPrice: "$529.20",
      facilities: ["Unlimited secure orders/month", "Checkout Extension", "Claim Management", "Return Management", "Chat Support"],
    },
    {
      id: 5,
      title: "Ultimate",
    ...
    <>
      ...
      <Container>
        <SectionTitle
          ...
          bottomText={"Choose a plan that fits your business—small, medium, or large. No surprises, just value-packed features."}
        />
          ...
          {pricingData.map((item) => (
            ...
            >
              ...
              <p className="mt-[16px] lg:mt-[32px] text-[#FFFFFFCC] text-sm font-normal leading-6">
                ...
                / {item.title === "Lifetime Deal" ? "One-TimePayment" : isMonthly ? "per month" : "per year"}
              </p>

              <Button variant="secondary-outline" onClick={() => navigate("/contact-us")} className={"mt-[24px] lg:mt-[32px] w-full"}>
                Contact Us
              </Button>
              ...
              <div className="flex flex-col gap-4">
                ...
                {item.facilities.map((facility, index) => (
                  <div className="flex items-center gap-2" key={index}>
                    ...
                    <p className="text-[#ffffffcc] text-[13px] lg:text-[14px] leading-[22px]">{facility}</p>
                  </div>
                ))}
              </div>
            </div>
