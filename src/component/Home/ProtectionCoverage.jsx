          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 justify-center gap-[30px] py-[26px]">
            ...
            <div className="flex flex-col gap-6">
              <div className="flex justify-center items-center gap-3">
                ...
                <p className="text-xl font-normal leading-[30px]">Protection Coverage</p>
                <img src={leftSideHr} alt="" className="max-w-[100px]" />
              </div>
              <h1 className="text-5xl font-semibold text-gradient leading-[72px]">Total Coverage & Claims Management</h1>
              <p className="text-[#A6A6A6] text-lg font-light leading-[27px]">
                Purchasers crave carbon-neutral shipping options and total package protection. Guide Protection makes it easy to give the
            ...
            <div className="w-full lg:w-[744px] lg:h-[370px] flex items-center justify-center">
              ...
              <div ref={containerRef} className="relative w-[370px] h-[370px] border-2 border-[#FFFFFF4D] rounded-full z-10">
                ...
                {protectionCoverageOptions.map((opt, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <h3 className="text-xl font-normal text-white">{opt.title}</h3>
                    </div>
                  );
                })}
              </div>
