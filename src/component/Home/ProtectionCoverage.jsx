    ...
    <div className="w-full relative bg-gradient-to-r from-white/5 to-white/5 backdrop-blur-[37px] overflow-hidden">
      ...
      <Container>
        <div className="relative py-[24px] lg:py-[150px] mx-auto z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 justify-center items-center gap-[24px] lg:gap-[30px] py-[26px]">
                ...
                {protectionCoverageOptions.map((opt, index) => {
                  ...
                  return (
                    <div
                      ...
                      className="absolute flex items-center gap-4 p-[7px] lg:p-3 bg-[#000000] rounded-[5px] lg:rounded-lg z-20"
                      style={{
                        top: position.top,
                        left: position.left,
                    ...
                    >
                      <div className="p-2 bg-[#98FF9317] rounded-sm">
                        <CustomIcon iconName={opt.iconName} className={"w-3.5 h-3.5 md:w-6 md:h-6"} />
                      </div>
