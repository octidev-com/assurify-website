          ...
          <div className='flex flex-col gap-4 md:gap-[30px]'>
            {benefitsData.map((benefit) => (
              <div
                ...
                <h3 className='text-h3-mobile lg:text-h3-desktop font-normal text-white leading-heading'>
                  {benefit.title}
                </h3>
                <p className='text-normal-paragraph-mobile lg:text-normal-paragraph-desktop font-normal leading-paragraph text-gray'>
                  {benefit.description}
                </p>
              </div>
            ))}
