        ...
        <div className='flex gap-[30px]'>
          ...
          <div className='max-w-[570px] flex flex-col gap-8'>
            <div className='flex flex-col gap-4'>
              ...
              <p className='text-[32px] text-[#f7f7f7] font-semibold leading-12'>
                $1,140.00
              </p>
              ...
              <div className='flex flex-col gap-6'>
                ...
                <div className='flex flex-col gap-3'>
                  ...
                  <p className='text-base font-light text-[#A6A6A6] leading-[24px] tracking-[-0.16px]'>
                    With the Assurify Lifetime Deal, originally priced at $1,140
                    but now available for only $69.99, you gain access to a
                    robust suite of tools that keep your digital life secure and
                    hassle-free.
                  </p>
                  <p className='text-base font-light text-[#A6A6A6] leading-[24px] tracking-[-0.16px]'>
                ...
                <div className='flex flex-col gap-4'>
                  ...
                  <div className='flex flex-col gap-3'>
                    <h1 className='text-[32px] font-semibold text-[#f7f7f7] leading-12 tracking-[-0.32px]'>
                      Table of Contents
                    </h1>
                    <h2 className='text-2xl font-medium text-[#f7f7f7] leading-9 tracking-[-0.24px]'>
                      1. What is Assurify
                    </h2>
                    <p className='text-base font-light text-[#A6A6A6] leading-[24px] tracking-[-0.16px]'>
                  ...
                  <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-base font-light text-[#A6A6A6] leading-[24px] tracking-[-0.16px]'>
                      ...
                      increasing daily. Personal data theft, password breaches,
                      and identity fraud have become significant concerns.
                      Assurify provides:
                    </p>
                  ...
                  <div className='flex flex-col gap-3'>
                    ...
                    <p className='text-base font-light text-[#A6A6A6] leading-[24px] tracking-[-0.16px]'>
                      ...
                      crowded security app market. Here are some key highlights:
                    </p>
                    <ul className='list-disc list-inside text-[12px] font-light text-[#A6A6A6] leading-[24px] tracking-[-0.16px]'>
                      <li>
                      ...
                      <li>
                        ...
                        Generate and store strong, unique passwords for all your
                        accounts securely.
                      </li>
                      <li>
                        <span className='font-normal text-[#f7f7f7]'>
                        ...
                        Organize and access your critical documents safely from
                        anywhere.
                      </li>
                      <li>
                        <span className='font-normal text-[#f7f7f7]'>
                      ...
                      <li>
                        ...
                        Sync Assurify across devices for seamless access to your
                        data.
                      </li>
                    </ul>
                  </div>
            ...
            {activeTab === 'reviews' && (
              <div className='grid grid-cols-3 gap-[30px]'>
                ...
                <div className='col-span-1'>
                  <h5 className='text-[#f7f7f7] font-semibold text-2xl'>
                    Ratings
                  </h5>
                  <p className='mt-[5px] text-[#A6A6A6] text-base font-light leading-[24px] tracking-[-0.16px]'>
                    Ratings and reviews are verified and are from people who use
                    the service
                  </p>
                  ...
                  <p className='text-[#A6A6A6] text-xl font-normal leading-[20px]'>
                  ...
                  <div className='p-4 mt-[30px] bg-[linear-gradient(90deg,rgba(255,255,255,0.03)_0%,rgba(255,255,255,0.03)_100%)] backdrop-blur-[37px] rounded-2xl flex flex-col gap-3'>
                    <h5 className='text-xl font-semibold text-[#f7f7f7]'>
                      Add your comment
                    </h5>
                    <div className='flex items-center justify-between'>
                      <p className='text-lg text-[#f7f7f7] font-light'>
                        Ratings
                      </p>
                      <div className='flex gap-1'>
                        {[1, 2, 3, 4, 5].map((item) => (
                      ...
                      <React.Fragment key={item}>
                        <div className='flex flex-col gap-3 mt-3'>
                          ...
                          <p>
                            ...
                            safeguard your online presence? Assurify is here to
                            redefine digital security and organization.
                          </p>
